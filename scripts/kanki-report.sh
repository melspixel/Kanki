...

{
    ...
    for file in libanki-kanki.so kanki-device kanki-sync kanki-raise kanki-audio kanki-gst-play; do
...
# Never copy config.ini, collection.anki2, collection.media, browser history,
# account files, Wi-Fi configuration or Kindle identifiers into the report.
